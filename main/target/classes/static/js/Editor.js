...
function resizer(elemClass) {
    document.getElementsByClassName('resizer').slice().forEach(function (el) { el.remove(); });
    document.getElementsByClassName('move').slice().forEach(function (el) { el.remove(); });
    document.getElementsByClassName('edit').slice().forEach(function (el) { el.remove(); });
    document.getElementsByClassName('exitResizer').slice().forEach(function (el) { el.remove(); });
    disableScrolling();
