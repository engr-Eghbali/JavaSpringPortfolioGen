...
function fSearch(Query){
    ...
    if(info=storageRetrieve("MateUserInfo")){
        ...
        url="https://guarded-castle-67026.herokuapp.com/Whois";
        data="id="+info.id+"&vc="+info.vc+"&query="+Query;
        serverPostRequest(url,data,fSearchCallBack);    
...
function frequest(account){
    ...
    if(info=storageRetrieve("MateUserInfo")){
        ...
        url="https://guarded-castle-67026.herokuapp.com/Frequest";
        data="id="+info.id+"&vc="+info.vc+"&frequest="+name;
        serverPostRequest(url,data,frequestCallBack);    
